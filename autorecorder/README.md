...
Currently configured for **Deep Agents (TypeScript) + React** — the 8 routes of
...
Videos land in `videos/` as `DEEPAGENTS-TS-react-<NN>-<name>.webm`, 1920×1080, ~25fps
...
every demo at `<route>/demo-chat`. This app tracks 12 doc routes; the 4 that carry no
